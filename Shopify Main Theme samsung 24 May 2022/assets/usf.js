...
<div class="usf-sr-container" :class="{'usf-no-facets': noFacets, 'usf-empty': !loader && !hasResults, 'usf-nosearch': !showSearchBox}">
    ...
    <ul :data-id="usfSettings.sectionId" :class="(view === \'grid\' ? \'grid grid--2-col \'+ (loader === true || hasResults ?getClassWrapper(result) : ' grid--4-col-desktop ') : \'list-view-items\') + \' usf-results usf-clear usf-\' + view">
...
<li class="grid__item" :product-selector="product.id" :data-usf-pid="product.id">
    <div class="card-wrapper">
        ...
        <a :href="productUrl" @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" class="full-unstyled-link usf-sr-product__image-container">
           ...
           <div class="card card--product"  tabindex="-1">
                <div class="card__inner">
                    <div :class="{'card__media-full-spacer':usfSettings.add_image_padding}">
                        <div class="media media--hover-effect usf-sr-product__image-container" :class="'media--transparent media--'+usfSettings.image_ratio" :style="'padding-bottom:' + 100/_usfGetImageRatio(selectedImage) + '%;'">
            ...
            <div class="card-information">
                <div class="card-information__wrapper">
                    <template v-if="usfSettings.show_vendor && usf.settings.search.showVendor">
                        ...
                        <div v-html="product.vendor" class="caption-with-letter-spacing light"></div>
                    </template>
...
var getClassWrapper = (rs) => {
    ...
    if (count < 4) {
        ...
        if (count == 4) {
            gridClass += 'grid--4-col-desktop';
        } else {
            gridClass += 'grid--3-col-tablet grid--one-third-max grid--4-col-desktop grid--quarter-max';
        }
    }
    return gridClass;
}
